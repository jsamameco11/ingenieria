...
export const SITE_QUESTIONNAIRES: Record<string, SiteQuestionnaire> = {
  INGENIERIA: {
    ...
    lead: "Completar esta ficha habilita la edición y ordena avisos, módulos y la plaza de Compras según su oficio.",
    why: "El servicio gratuito se sostiene con una experiencia pertinente: especialidad, territorio y lo que consulta en Compras. No vendemos su ficha a terceros.",
    fields: [],
  },
  CONTRATACIONES: {
    code: "CONTRATACIONES",
