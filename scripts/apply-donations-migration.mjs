...
const MIGRATION = "C:/Users/Renzo/Desktop/APP BIBLIAS/casa-de-la-palabra-database/supabase/migrations/20260909000002_donations.sql";
...
try {
  ...
  console.log("Tabla casa_donations creada.");
  const { rows } = await client.query(`
    select table_name from information_schema.tables
    where table_schema='public' and table_name = 'casa_donations'
  `);
  console.table(rows);
} finally {
  await client.end();
