...
const MIGRATION = "C:/Users/Renzo/Desktop/APP BIBLIAS/casa-de-la-palabra-database/supabase/migrations/20260913000001_study_main_verse_reference.sql";
...
try {
  ...
  console.log("Columnas de versículo principal agregadas.");
  await client.query(`NOTIFY pgrst, 'reload schema'`);
  const { rows } = await client.query(`
    select column_name from information_schema.columns
    where table_schema='public' and table_name='casa_studies' and column_name like 'main_verse%'
