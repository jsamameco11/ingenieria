...
const MIGRATION = "C:/Users/Renzo/Desktop/APP BIBLIAS/casa-de-la-palabra-database/supabase/migrations/20260912000001_study_builder.sql";
...
try {
  ...
  console.log("Migración del constructor de estudios aplicada.");
  ...
  const { rows: cols } = await client.query(`
    ...
    where table_schema='public' and table_name='casa_studies' and column_name in ('subtitle','main_verse','social_image_url')
  `);
  console.table(cols);
} finally {
  await client.end();
